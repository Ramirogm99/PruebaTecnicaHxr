...
NOTA 1: Toda clase no existente en el sistema actual debe tener su test unitario correspondiente usando phpunit e instalado mediante composer en la raiz del proyecto.
NOTA 2: No es necesario implementar para el sistema real las clases de los repositorios: SalaryRepository o UserRepository ni la clase Timer.